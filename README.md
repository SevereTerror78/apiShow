...
| /directors/director/films        | GET         |      | all films for directors     |>>✓
| /actors/actor/films              | GET         |      | all films for actors        |>>✓
| /films/film/directors            | GET         |      | all film's directors        |>>✓
| /films/film/directors            | POST        | Y    | new director added to films |>>✓
| /films/film/directors/director   | PATCH       | Y    | edited director by films id |>>✓
| /films/film/directors            | DELETE      | Y    | id                          |>>✓
| /films/film/actors               | GET         |      | all actors for films        |>>✓
| /films/film/actors               | POST        | Y    | new actor added to the films|>>✓
| /films/film/actors/actor         | PATCH       | Y    | edited actros for films     |>>✓
